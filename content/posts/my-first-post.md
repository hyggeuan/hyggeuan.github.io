...
<!-- 嵌入图片并应用放大镜效果 -->
<a href="{{ "https://i.postimg.cc/CxGzPBpj/image.png" | absURL }}" data-lightbox="image-1" data-title="Click to enlarge">
    <img src="{{ "https://i.postimg.cc/CxGzPBpj/image.png" | absURL }}" alt="放大图片" class="magnify" data-big="{{ "https://i.postimg.cc/CxGzPBpj/image.png" | absURL }}" style="max-width: 100%; cursor: zoom-in;">
</a>
